...
__export(src_exports, {
  ...
  createAsyncFileSystem: () => createAsyncFileSystem,
  createExtendedFileSystemPromiseActions: () => createExtendedFileSystemPromiseActions,
  createExtendedSyncActions: () => createExtendedSyncActions,
  createFileSystem: () => createFileSystem,
  createSyncFileSystem: () => createSyncFileSystem,
  syncToAsyncFs: () => syncToAsyncFs
});
