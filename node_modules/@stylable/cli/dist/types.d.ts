 ...
 * }
 */
export type Configuration<P extends string = string> = SingleProjectConfig | MultipleProjectsConfig<P>;
export type ConfigurationProvider<P extends string = string> = () => Configuration<P>;
/**
 * @deprecated use stcConfig() instead
 */
export declare function typedConfiguration<P extends string>(configOrConfigProvider: Configuration<P> | ConfigurationProvider<P>): Configuration<P> | ConfigurationProvider<P>;
export declare function stcConfig<P extends string>(configOrConfigProvider: Configuration<P> | ConfigurationProvider<P>): Configuration<P> | ConfigurationProvider<P>;
...
export type ResolveRequests = (projects: Array<RawProjectEntity>, context: ResolveProjectsContext) => Promise<STCProjects> | STCProjects;
...
export type Projects<P extends string> = Array<string | [string, ProjectEntryValues<P>]> | Record<string, ProjectEntryValues<P>>;
...
export type ProjectEntryValues<P extends string> = ProjectEntryValue<P> | Array<ProjectEntryValue<P>>;
export type ProjectEntryValue<P extends string> = P | PartialBuildOptions | {
    preset?: P;
    presets?: Array<P>;
    options: PartialBuildOptions;
};
