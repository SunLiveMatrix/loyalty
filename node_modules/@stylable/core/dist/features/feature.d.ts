...
import type { InferredSelector, ScopeContext, StylableExports, StylableTransformer } from '../stylable-transformer';
...
export interface FeatureHooks<T extends NodeTypes = NodeTypes> {
    ...
    analyzeAtRule: (options: {
        ...
        analyzeRule: (rule: postcss.Rule, options: {
            isScoped: boolean;
...
export declare function createFeature<T extends NodeTypes>(hooks: Partial<FeatureHooks<T>>): FeatureHooks<T>;
export {};
