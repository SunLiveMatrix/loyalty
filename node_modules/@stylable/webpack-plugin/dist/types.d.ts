...
export type BuildData = Pick<StylableBuildMeta, 'css' | 'namespace' | 'depth' | 'exports' | 'isUsed' | 'urls'>;
export type LoaderData = Pick<StylableBuildMeta, 'css' | 'urls' | 'exports' | 'namespace' | 'globals' | 'unusedImports' | 'cssDepth' | 'type'>;
